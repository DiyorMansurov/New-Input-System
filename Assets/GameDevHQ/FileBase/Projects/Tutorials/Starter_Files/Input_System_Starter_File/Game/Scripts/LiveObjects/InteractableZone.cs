...
namespace Game.Scripts.LiveObjects
{
    public class InteractableZone : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            _input.Human.Interact.started += OnInteractStarted;
            _input.Human.Interact.performed += OnInteractPerformed;
            _input.Human.Interact.canceled += OnInteractCanceled;
...
// --------------------------------------------------------------------------------------------------------
        ...
        {
            if (_inZone && _keyState == KeyState.PressHold && _inHoldState == false)
                {
                    _inHoldState = true;
